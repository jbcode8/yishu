...
class CategoryController extends AdminController {
    ...
    public function index(){
        ...
        foreach($list as $k=>$v){
            ...
            $tablelist[$v['cate_id']]['manage'] = "".PHP_EOL.
                "<a class=\"fa fa-edit\" href=\"javascript:$.dialog.open('".U('Ask/Category/edit?cate_id='.$v['cate_id'])."',{title:'修改分类',id:'doCategory'});\"> 修改分类</a>".PHP_EOL.
                "<a class=\"fa fa-plus-square\" href=\"javascript:$.dialog.open('".U('Ask/Category/add?parent_id='.$v['cate_id'])."',{title:'添加子类别',id:'doCategory'});\"> 添加子类别</a>".PHP_EOL.
                "<a class=\"fa fa-trash-o red ajax-get\" href=\"".U('Ask/Category/delete?cate_id='.$v['cate_id'])."\"> 删除</a>";
        ...
        $str = "<tr data-tt-id='\$id' \$pid_node>".PHP_EOL.
            ...
            "<td style='text-align:left;'>\$spacer \$name</td>".PHP_EOL.
    ...
    public function editattr(){
        ...
        $this->info = D('Category')->field('cate_id, name, parent_id')->find($cate_id);
        $this->display();
    }
    // 删除之前的判断
