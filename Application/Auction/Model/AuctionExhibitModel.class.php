...
use Think\Model;
class AuctionExhibitModel extends Model {
    ...
    protected $_validate = array(
		...
		array('starttime', 'require', '请选择开始时间！'),
		array('endtime', 'require', '请选择结束时间！'),
		array('meetingid', 'require', '请选择拍卖会！'),
		array('specialid', 'require', '请选择专场！'),
