...
class MpublicController extends MemberController {
    ...
    public function _initialize(){
        ...
        if(isset($_SESSION['store_id']) && $_SESSION['store_id'] > 0){
            ...
            $this->gInfo = D('MallStore')->where($where)->find();
            ...
            if($aryInfo){
                ...
                // 锁定
                $aryInfo['status'] == 2 AND $this->error('很抱歉，您的店铺已经被锁定，暂时将无法操作，请联系管理员。');

                // 待审
                $aryInfo['status'] == 0 AND $this->error('您好，您的店铺申请正在审核中....', U('Member/Index/index'));
