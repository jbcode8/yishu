...
class ArticleModel extends MallBaseModel{
    ...
    public function listByCateId($cate_id, $size = 5){
        return $this->field('article_id,title')->where(array('cate_id'=>$cate_id,'store_id'=>0))->order('listorder ASC')->limit($size)->select();
    }
}