<?php
	...
	class GoodsService{
		...
		*/
		public function goodsViewInc(){
			if(!$_COOKIE['pageviewinc']){
				$flag = M('jishou_goods')->where(array('goods'=>$this->goodsid))
						->setInc('page_view');
				setcookie('pageviewinc',true);
			}
			return true;
		}
