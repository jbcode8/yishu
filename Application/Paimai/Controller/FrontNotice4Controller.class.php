...
class FrontNotice4Controller extends PaimaiPublicController
{
    ...
    public function index()
    {
        ...
        $goods = M("PaimaiGoods")->where($where)->order('goods_starttime DESC')->page($p . ',' . $prePage)->select();
		//dump($goods);
